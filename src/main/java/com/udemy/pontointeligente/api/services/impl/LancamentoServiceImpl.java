...
import com.udemy.pontointeligente.api.entities.Lancamento;
import com.udemy.pontointeligente.api.repositories.LancamentoRepository;
...
public class LancamentoServiceImpl implements LancamentoService {
	...
	public Optional<Lancamento> buscarPorId(Long id) {
		log.info("Buscando lançamento ID {}", id);
