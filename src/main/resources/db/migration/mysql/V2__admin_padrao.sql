...
VALUES (NULL, '82198127000121', CURRENT_DATE(), CURRENT_DATE(), 'Waldrich IT');
...
VALUES (NULL, '16248890935', CURRENT_DATE(), CURRENT_DATE(), 'admin@udemy.com', 'ADMIN', 'ROLE_ADMIN', NULL, NULL, 
